...
function deleteOrCopyFrame(e) {
  ...
  if (e.target.classList[0] === 'frame-copy') {
    ...
    updateDataPartLi();
    console.log(eventItem + 1, eventItem);
    console.log(previewCanvases[eventItem + 1], previewCanvases[eventItem], previewCanvases);
    console.log(framesData["getData"]());
